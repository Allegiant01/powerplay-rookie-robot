...
@TeleOp
public class FieldCentricMecanumLED extends LinearOpMode {
            ...
            bRightMotor.setPower(fLeftPower);
             ...
             //heights for linear slide are for medium junctions
                if(gamepad1.left_bumper) {
                    ...
                    linearSlide2.setTargetPosition(1700);
                    linearSlide2.setMode(RUN_TO_POSITION);
                    linearSlide2.setPower(1);
                    linearSlide.setMode(RUN_TO_POSITION);
                    linearSlide.setPower(1);
                    telemetry.addData("Left linear slide position", linearSlide.getCurrentPosition());
                    telemetry.addData("Right linear slide position", linearSlide2.getCurrentPosition());
                    telemetry.update();
                    coolLights.setPattern(RevBlinkinLedDriver.BlinkinPattern.DARK_GREEN);
                }
